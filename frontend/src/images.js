export default [
    {
        options: [
            ...
            },
            {
                ...
                text:"Your work involves reading various data tables / reports / graphs / dashboardsYou often are looking at solving tactical problems in businessYou generate reports describing What has happened in your line of workFrom a given data set you often try to identify what is causing a trend and come up with call to action / suggestions / recommendations based on your analysis"
            },
            {
                imageUrl:"undraw_data_reports_706v.svg",
                text:"You are at a leadership level.You often are in charge of shaping up the right behaviours and work cultureYou realize the potential of data based decision and the importance of data literacy and fluency among your teams."
            }
        ]
    }
]